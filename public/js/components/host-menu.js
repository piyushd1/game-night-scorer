...
export function renderTopBarActions(roomCode) {
  ...
  actionsEl.innerHTML = `
    ...
    ${showMenu
      ? `<button id="btn-host-menu-trigger" aria-label="Open menu" aria-haspopup="menu" aria-expanded="false" class="material-symbols-outlined hover:bg-surface-container-high transition-colors p-1 ml-1" style="font-size:1.375rem">more_vert</button>`
      : ''
    }
  `;
