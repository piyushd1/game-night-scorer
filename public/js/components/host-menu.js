...
export function renderTopBarActions(roomCode) {
  ...
  actionsEl.innerHTML = `
    <button id="btn-qr-share" aria-label="Show QR code" title="Share room QR" class="material-symbols-outlined hover:bg-surface-container-high transition-colors p-1 rounded-sm focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-secondary" style="font-size:1.375rem">qr_code_2</button>
    ${showMenu
      ? `<button id="btn-host-menu-trigger" aria-label="Open menu" class="material-symbols-outlined hover:bg-surface-container-high transition-colors p-1 ml-1 rounded-sm focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-secondary" style="font-size:1.375rem">more_vert</button>`
      : ''
    }
  `;
