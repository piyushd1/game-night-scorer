  ...
  if (isHost) {
    ...
    if (isFlip7Host) {
      ...
      content.querySelector('#btn-edit-save')?.addEventListener('click', async () => {
        ...
        saveBtn.innerHTML = '<div class="spinner mx-auto"></div><span class="sr-only">Saving...</span>';
...
async function _confirmFlip7Round(container, roomCode, initialGame, gameModule) {
  ...
  if (btn) { btn.disabled = true; btn.innerHTML = '<div class="spinner mx-auto"></div><span class="sr-only">Submitting...</span>'; }
