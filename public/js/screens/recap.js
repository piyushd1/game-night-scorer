...
export function mount(container, params = {}) {
  ...
  document.getElementById('top-bar-actions').innerHTML = locked
    ? `<span class="font-mono text-[10px] text-outline border border-outline px-2 py-1 flex items-center gap-1"><span class="material-symbols-outlined text-[12px]" aria-hidden="true">lock</span>LOCKED</span>`
    : '';
      ...
      html += `
        <div class="bg-primary text-on-primary p-6 mb-8">
          <div class="flex items-center gap-2 mb-2">
            <span class="material-symbols-outlined" style="font-variation-settings: 'FILL' 1;" aria-hidden="true">emoji_events</span>
  ...
  html += `
    <section class="mb-10">
      <h3 class="font-headline font-extrabold uppercase text-sm tracking-widest mb-4 flex items-center gap-2">
        <span class="material-symbols-outlined text-sm" aria-hidden="true">leaderboard</span>
        OVERALL STANDINGS
      </h3>
    ...
    if (game.winner && game.snapshot[game.winner]) {
      ...
      html += `
        <div class="bg-surface-container-high border border-outline p-3 mb-3 flex items-center gap-3">
          <span class="material-symbols-outlined text-sm" style="font-variation-settings: 'FILL' 1;" aria-hidden="true">emoji_events</span>
      ...
      html += `
        <div class="bg-surface-container-high border border-outline-variant p-3 mb-3 flex items-center gap-3">
          <span class="material-symbols-outlined text-sm text-outline" aria-hidden="true">cancel</span>
